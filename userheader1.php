                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Settings <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li><a href="userviewownprofile.php">Profile</a></li>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-12">
                        <div class="slider_text text-center">
                            ...
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">Watch Our Videos<p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s"> Enjoy Your Time</p>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
               <!--  <div class="card-heading">
                ...
                <div class="card-body">
                    <h2 class="title" align="center">Summary</h2>
                    <form method="POST">
                        
                        <table align="center" width="100%" class="table">
    <tr align="center"  > 
        <th style="color: #a781d6"> User Name</th>
        <th style="color: #a781d6">Rank</th>
        <th style="color: #a781d6">No.Of Uploads</th>
        <th style="color: #a781d6">No. Of Likes</th>

    </tr>
    <?php
    extract($_GET);
    $q="SELECT COUNT(`video_id`) AS vdo,SUM(`like_count`) AS lk,CONCAT(`user_fname`,' ',`user_lname`) AS user_name,`rank`,`user_id` FROM `videos` INNER JOIN `user` USING(`user_id`) WHERE `user_id`='$id'";
    $result=select($q);
    foreach($result as $row)
    {
        ?>
        <tr>
        <td align="center"  style="color: white"><?php echo $row['user_name'];?></td> 
            <td align="center" style="color: white"> <?php echo $row['rank'];?></td> 
                <td align="center" style="color: white"> <?php echo $row ['vdo'];?> </td> 
                    <td align="center"style="color: white"> <?php echo $row ['lk'];?> </td> 

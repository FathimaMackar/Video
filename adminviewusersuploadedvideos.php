                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            <li><a href="adminhome.php"style="color: white">Home</a></li>
                                                    ...
                                                    <li><a href="adminviewvideostatus.php"style="color:white ">View Video Status</a></li>
...
<head>
    ...
    <!-- Title Page-->
    <title>View User Uploaded Videos</title>
...
<body>
    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title" align="center">User Uploaded Videos</h2>
                    <form method="POST">
    ...
    <tr align="center"  > 
        ...
        <th style="color: #a781d6"> Approve/Reject </th>
    ...
    <?php
   $s="SELECT videos.*, categories.* from videos inner join categories on categories.category_id = videos.category_id where videos.user_id<>'1'";
    $result=select($s);
    foreach($result as $row)
    {
       ...
       <td style="color: white" align="center"><?php echo $row['video_title'];?></td> 
        <td style="color: #a781d6" align="center"> <video width="400px" height="240" controls>
                    ...
                    <td  style="color: white" align="center"> <?php echo $row ['v_date'];?> </td> 
                        <td  style="color: white" align="center"> <?php echo $row ['category_name'];?> </td> 
                            <td  style="color: white" align="center"> <?php echo $row ['status'];?> </td>
                             <td  style="color: white" align="center"><a href="approvevideos.php?id=<?php echo $row['video_id']; ?>">Approve</a>
                            <a href="rejectvideos.php?id=<?php echo $row['video_id']; ?>">Reject</a> </td> 
